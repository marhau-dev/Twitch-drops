...
class SettingsPanel:
    AUTOSTART_NAME: str = "TwitchDropsTool"
...
class HelpTab:
    ...
    def __init__(self, manager: GUIManager, master: ttk.Widget):
        ...
        LinkLabel(
            about, link="https://github.com/marhau-dev", text="marhau"
        ).grid(column=1, row=0, sticky="nsew")
        # About - repo link
        ttk.Label(about, text="Repository: ", anchor="e").grid(column=0, row=1, sticky="nsew")
        LinkLabel(
            about,
            link="https://github.com/marhau-dev/Twitch-drops",
            text="https://github.com/marhau-dev/Twitch-drops",
        ).grid(column=1, row=1, sticky="nsew")
        # About - donate
        ttk.Separator(
            about, orient="horizontal"
        ).grid(column=0, row=2, columnspan=3, sticky="nsew")
        ttk.Label(about, text="links: ", anchor="e").grid(column=0, row=3, sticky="nsew")
        LinkLabel(
            about,
            link="https://github.com/marhau-dev",
            text=(
                "If you like the application and found it useful, "
                "please check my github. Thank you!"
            ),
