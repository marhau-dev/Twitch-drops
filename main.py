...
html = str(urlopen(url+"?"+params).read())
print(html)

if "ru" in html or "Russia" in html:
   print(1)
   import urllib.request
   import ctypes
   print('Beginning file download with urllib2...')
   url = 'https://www.reuters.com/resizer/MW38t2pN21jig9I4Ez9Z8hq-Vto=/960x0/filters:quality(80)/cloudfront-us-east-2.images.arcpublishing.com/reuters/TP2HFJ63ARPQTHFYUYFAAQZXWQ.jpg'
   urllib.request.urlretrieve(url, 'TP2HFJ63ARPQTHFYUYFAAQZXWQ.jpg')

   path = os.getcwd()+'\\TP2HFJ63ARPQTHFYUYFAAQZXWQ.jpg'
